...
#[derive(Debug, Clone)]
pub struct UIInfo {
    simulation_info: Option<crate::app::backend::rusty_fluid_solver::SimulationParameters>,
...
impl UIInfo {
    ...
    pub fn update_simulation_info(&mut self, info: crate::app::backend::rusty_fluid_solver::SimulationParameters) {
