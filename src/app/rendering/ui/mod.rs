...
impl UIState {
    ...
    pub fn new_simulation(&mut self, info: crate::app::backend::rusty_fluid_solver::SimulationParameters) {
        self.controls.new_simulation(info);
    }

    pub fn update_time_step_info(&mut self, info: Option<&crate::app::backend::rusty_fluid_solver::TimeStepInfo>, queue_length: usize) {
